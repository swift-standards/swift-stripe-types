...
extension Stripe.Charges {
    ...
    public struct Client: Sendable {
        ...
        public var create:
            @Sendable (_ request: Stripe.Charges.Create.Request) async throws(Witness.Unimplemented.Error) ->
                Stripe.Charges.Charge

        // https://docs.stripe.com/api/charges/retrieve.md
        public var retrieve:
            @Sendable (_ id: Stripe.Charges.Charge.ID) async throws(Witness.Unimplemented.Error) -> Stripe.Charges.Charge
        ...
        public var update:
            @Sendable (_ id: Stripe.Charges.Charge.ID, _ request: Stripe.Charges.Update.Request)
                async throws(Witness.Unimplemented.Error) -> Stripe.Charges.Charge

        // https://docs.stripe.com/api/charges/list.md
        public var list:
            @Sendable (_ request: Stripe.Charges.List.Request) async throws(Witness.Unimplemented.Error) ->
        ...
        public var search:
            @Sendable (_ request: Stripe.Charges.Search.Request) async throws(Witness.Unimplemented.Error) ->
