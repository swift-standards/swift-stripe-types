...
extension Stripe.Fraud.Reviews {
    ...
    public struct Client: Sendable {
        ...
        public var retrieve: @Sendable (_ id: Review.ID) async throws(Witness.Unimplemented.Error) -> Review
        ...
        public var approve:
            @Sendable (_ id: Review.ID, _ request: API.Approve.Request) async throws(Witness.Unimplemented.Error) -> Review
    }
}
