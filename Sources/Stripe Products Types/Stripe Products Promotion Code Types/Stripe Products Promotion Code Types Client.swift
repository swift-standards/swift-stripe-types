...
extension Stripe.Products.PromotionCodes {
    ...
    public struct Client: Sendable {
        ...
        public var create: @Sendable (_ request: Create.Request) async throws(any Swift.Error) -> Promotion.Code

        // https://docs.stripe.com/api/promotion_codes/retrieve.md
        public var retrieve: @Sendable (_ id: Promotion.Code.ID) async throws(any Swift.Error) -> Promotion.Code

        // https://docs.stripe.com/api/promotion_codes/update.md
        public var update:
            @Sendable (_ id: Promotion.Code.ID, _ request: Update.Request) async throws(any Swift.Error) ->
                Promotion.Code
